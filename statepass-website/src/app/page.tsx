...
export default function Home() {
  ...
  const openExtensionGuide = () => setShowExtensionGuide(true);
  const closeExtensionGuide = () => setShowExtensionGuide(false);
      ...
      <main className={styles.main}>
        <div className={styles.header}>
          ...
          <button
            ...
            className={styles.addExtensionBtn}
          ...
          >
            ...
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={styles.externalIcon}>
        ...
        {showExtensionGuide && (
          <div className={styles.extensionModalOverlay} onClick={closeExtensionGuide}>
            <div className={styles.extensionModal} onClick={(event) => event.stopPropagation()}>
              <div className={styles.extensionModalHeader}>
                <h3>Add StatePass Extension</h3>
                <button
                  type="button"
                  className={styles.extensionModalClose}
                  onClick={closeExtensionGuide}
                  aria-label="Close extension guide"
                >
                  ×
                </button>
              </div>
              ...
              <ol className={styles.extensionSteps}>
                <li>Open the Chrome Extensions page.</li>
                <li>Turn on <strong>Developer mode</strong>.</li>
                <li>Click <strong>Load unpacked</strong>.</li>
                <li>Select the <strong>statepass-ext/src</strong> folder from this project.</li>
              </ol>

              <div className={styles.extensionModalActions}>
                <a
                  href="chrome://extensions"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={styles.extensionModalLink}
                >
                  Open Extensions Page
                </a>
                <a
                  href="https://github.com/suky7E/statepass/tree/main/statepass-ext/src"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={styles.extensionModalSecondary}
                >
                  View Source Folder
                </a>
              </div>
